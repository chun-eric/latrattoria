...
function renderSingleBlogPost(postId) {
  if (!postId) {
    displayErrorMessage(
  ...
  if (post) {
    ...
    <article class="single-blog-post">
        ...
        <div class="blog-meta">
          <span class="blog-date">${post.date} <i class="fa-regular fa-calendar-days"></i></span>
...
function displayErrorMessage(message) {
  const blogPostContent = document.getElementById('blog-post-content');
  if (blogPostContent) {
    blogPostContent.innerHTML = `<p>${message}</p>`;
  }
}
